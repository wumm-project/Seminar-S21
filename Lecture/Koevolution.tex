...
\begin{frame}{Diagrams from (Holling 2001)}
  \begin{center}
    \includegraphics[width=.75\textwidth]{images/Holling-1.png}
  \end{center}
\end{frame}

\begin{frame}{Diagrams from (Holling 2001)}
  \begin{center}
    \includegraphics[width=.75\textwidth]{images/Holling-2.png}
  \end{center}
\end{frame}

\begin{frame}{Diagrams from (Holling 2001)}
  \begin{center}
    \includegraphics[width=.85\textwidth]{images/Holling-3.png}
  \end{center}
\end{frame}
